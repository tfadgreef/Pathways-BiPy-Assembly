% Script designed to draw Figure 3 for the BiPy paper, containing the 
% concentration-dependent trace fits in CD-,UV- and FL-channels. 
...
print(h_fig,'-depsc','-r300','-tiff','Figure 3b')
% cd(CurrDom)