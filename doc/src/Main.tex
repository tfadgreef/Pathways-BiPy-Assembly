...
\newcommand{\PPODESUITE}{\emph{PPODESUITE}~}
...
\newcommand{\matlabcmd}[1]{\\\indent\indent\texttt{\footnotesize >> #1}\\}
\newcommand{\sourceword}[1]{\texttt{\footnotesize#1}}
\newcommand{\ph}[1]{\textlangle #1\textrangle}
...
\lstdefinestyle{fortrancode}{
  ...
  alsoletter={.,+,-,*,=},
  emph={[1], .eq., .gt.,},
  emphstyle={[1]\color[rgb]{0.0,0.5,0.0}},
  emph={[2],+,-,*,=},
  emphstyle={[2]\color[rgb]{0.6,0.0,0.3}}
}
